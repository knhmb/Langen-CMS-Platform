<template>
  <div class="language-table">
    <el-table :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column prop="SLUG" label="SLUG" width="120" sortable />
      <el-table-column
        prop="CREATED BY"
        label="CREATED BY"
        width="150"
...
.language-table .el-table :deep(.el-table__cell.is-leaf) {
  background: #f2f5f8;
}

.language-table .el-table :deep(.el-table__cell.is-leaf .cell) {
  display: flex;
  align-items: center;
  justify-content: space-between;
}

.language-table .el-table :deep(.el-table__cell .cell) {
